...
// @TODO
// se eu nao atualizo a pagina de account/create fica meio estranho se eu ja usei e deu erro, embora funcional -> ACHO QUE ESSE É O NORMAL DO JS SE PA
// Se fico ligado por um tempo na pagina -> Unchecked runtime.lastError: The message port closed before a response was received
    ...
    for (let i = 0; i < allForms.length; i++){
        allForms[i].addEventListener("submit", function(e){
            ...
            app.client.request(undefined, path, method, queryStringObject, payload, function(statusCode, responsePayload) {
                ...
                // Set the formError field wit the error text
...
app.loadChecksListPage = function() {
    ...
    app.client.request(undefined, 'api/users', 'GET', queryStringObject, undefined, function(statusCode, responsePayload) {
        ...
        if (allChecks.length <= 0) {
            ...
            return document.getElementById("createCheckCTA").style.display = 'block';
        }
